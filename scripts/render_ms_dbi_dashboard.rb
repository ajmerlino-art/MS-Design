      ...
      <div class="wrap">
        ...
        <section class="panel active" id="panel-overview">
          ...
          <div class="overview-grid">
            ...
            <div class="box">
              ...
              <ul id="programHighlightsList"></ul>
            </div>
          </div>
        </section>
        ...
        <section class="panel" id="panel-workforce">
          ...
          <div class="fact-grid">
            ...
            <div class="fact-card">
              <div class="label">Employment (2024)</div>
              <div class="value" id="wfEmployment2024"></div>
              <div class="detail">Across aligned BLS anchor occupations</div>
            </div>
            <div class="fact-card">
              <div class="label">Projected (2034)</div>
              <div class="value" id="wfProjected2034"></div>
              <div class="detail">Across aligned BLS anchor occupations</div>
            </div>
            <div class="fact-card">
          ...
          <div class="overview-grid">
            <div class="box">
              <h3>Employment and Projection by Occupation</h3>
              <div class="table-wrap">
                <table style="min-width: 900px;">
                  ...
                  <tbody id="wfEmploymentRows"></tbody>
                </table>
              </div>
            </div>
            <div class="box">
        ...
        (function () {
          ...
          function renderTopMetricTable(metric) {
            ...
            if (metric === 'overview') {
              ...
              subtitle = 'Interactive summary of the program overview, vision focus, and program highlights.';
              ...
              tableHtml = '<div class="overview-grid">' +
                ...
                '</ul></div>' +
                '<div class="box"><h3>Program Highlights</h3><ul>';
              for (i = 0; i < highlights.length; i++) {
                tableHtml += '<li>' + escapeHtml(highlights[i]) + '</li>';
              }
              tableHtml +=
                '</ul></div>' +
                '</div>' +
          ...
          function initOverview() {
            ...
            $('programHighlightsList').innerHTML = html;
          }
          ...
          function initWorkforceAlignment() {
            ...
            $('wfEmployment2024').innerHTML = escapeHtml(blsTotals.employment_2024 || '');
            $('wfProjected2034').innerHTML = escapeHtml(blsTotals.projected_2034 || '');
            $('wfPipelineTotal').innerHTML = escapeHtml(pipeline.total_adjacent_masters_pipeline || '');

            var i, html = '';
            var employmentRows = blsTable.rows || [];
            for (i = 0; i < employmentRows.length; i++) {
              var row = employmentRows[i];
              html += '<tr>' +
                '<td>' + escapeHtml(row.bls_soc || '') + '</td>' +
                '<td>' + escapeHtml(row.employment_2024 || '') + '</td>' +
                '<td>' + escapeHtml(row.projected_2034 || '') + '</td>' +
            ...
            $('wfEmploymentRows').innerHTML = html;
